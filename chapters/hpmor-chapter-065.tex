...
<<~Est-ce que c'est moi ou est-ce que Harry Potter s'est mit à parler comme un livre encore plus \emph{compliqué} ces derniers jours~? Enfin, je ne l'ai pas écouté très longtemps -
...
--- \parsel{Tu vois erreur, pensse à la défaire, à annuler ce qui a été fait. Mais même avec un ssablier le temps ne peut être défait. Mieux vaut avancer. Tu pensses à convaincre les autres qu'ils ont tort. Bien plus ssimple de les convaincre qu'ils ont raison. Conssidères ceci, garçon~: quel heureux hasard pousserait le maître de l'école à décider que tu es de nouveau en ssécurité et ferait simultanément avancer tes autres projets~?}~>>
