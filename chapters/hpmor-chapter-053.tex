...
«~\parsel{Montrez-lui votre vissage,}~» siffla le serpent aux pieds de Harry.
...
«~\parsel{Ditess quelque chose en Fourchelangue}~», siffla le serpent.

Le visage de Harry se tourna vers le serpent afin de clairement montrer qu'il s'adressait à celui-ci, et il siffla~: «~\parsel{Un deux troiss quatre ccinq ssix ssept huit neuf dix.}~»
...
«~\parsel{Vous devrez la faire léviter jusqu'à la ssortie}, siffla Harry au serpent. \parsel{Elle ne peut plus ssonger à ss'enfuir.}

--- \parsel{Oui}, siffla le serpent, \parsel{mais ne la ssous-esstimez pas. Elle était la plus mortelle des guerrières.}~» La tête verte s'inclina en signe d'avertissement. «~\parsel{Il serait sage de me craindre, enfant, même si j'étais affamé et mort aux neufs dixièmes~; méfiez-vous d'elle, ne permettez à aucune faille d'apparaître dans votre jeu.}~»
