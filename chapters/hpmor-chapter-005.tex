...
\ldots il semblait que le sort de déguisement de McGonagall n'était pas parfaitement efficace contre les praticiens magiques expérimentés.
...
<<~Je pense que je comprends\ldots dit-elle lentement. Mais qu'est-ce que ça a à voir avec vous~?~>>
...
--- Celui au pouvoir capable de vaincre le Seigneur des Ténèbres\ldots~>> murmura McGonagall, une ironie dans la voix que Harry ne comprit alors pas.
...
--- J'\emph{ai} formé une conjecture\ldots dit McGonagall. Après vous avoir rencontré.
...
<<~Grands dieux, murmura Harry, ce n'est pas possible.~>> Il laissa ses yeux se dilater. <<~Votre\ldots{} nom, monsieur~?
...
Harry continua son murmure. <<~Je suis ravi de vous rencontrer M. Malfoy. Juste ineffablement ravi. Et aller à Poudlard la même année que vous~! Mon c\oe{}ur se pâme.~>>

Oups. Cette dernière partie avait peut-être été un peu étrange, comme si il flirtait avec Drago.

<<~Et mon propre c\oe{}ur est illuminé de constater que je puis m'attendre à être traité avec le respect dû à la famille Malfoy,~>> renvoya Malfoy avec un sourire similaire à l'un de ceux que le plus haut des rois pourrait octroyer au plus bas de ses sujets, si ce sujet était honnête en dépit de sa pauvreté.

Eh\ldots{} Mince, Harry avait du mal à inventer sa prochaine réplique. Eh bien, tout le monde \emph{voulait} serrer la main de Harry Potter, alors - <<~Lorsque mes vêtements seront apprêtés, monsieur, accepterez-vous de me serrer la main~? Rien d'autre ne saurait parachever ce jour, non, ce mois, et à vrai dire, ma vie entière.~>>
...
--- Wow,~>> dit Drago, l'air légèrement impressionné. Il fit une sorte de soupir mélancolique. <<~Votre flatterie était excellente, ou du moins je le pensais - vous réussiriez à Serpentard aussi. C'est généralement devant mon père que les gens s'aplatissent. J'\emph{espère} que les autres Serpentards me lécheront les bottes maintenant que je suis à Poudlard\ldots{} j'imagine donc que c'est bon signe.~>>
...
--- Deux des mes parents sont morts~>>, dit Harry. Il éprouva un pincement au c\oe{}ur. Lorsqu'il le formulait ainsi - <<~Mes deux autres parents sont des Moldus, et ce sont eux qui m'ont éduqué.
