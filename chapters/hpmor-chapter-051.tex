...
- siffla <<~\parsel{Faim, garçon~? mange ton content en vitesse, nouss aurons bessoin de forcces et de temps.}~>>
...
<<~\parsel{Ne ssouhaite pas expliquer icci. Préfère être ailleurs d'abord. Bessoin de partir pas vu, ssans ssigne que nouss avons jamais quitté piècce.}

--- \parsel{Pour que perssonne ne puisse nous suivre}, siffla Harry.
...
--- Mais les Détraqueurs ne sont \emph{pas} invincibles~>>, dit Harry. Il aurait pu lancer le Patronus grâce à cette pensée, à l'instant même. <<~Ne croyez jamais qu'il le sont.~>>
