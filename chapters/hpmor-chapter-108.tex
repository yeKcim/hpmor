...
--- \parsel{Pourquoi cette quesstion~?}~>> siffla le professeur de Défense en retour, avec une cadence qui, en Fourchelangue, exprimait l'amusement du serpent. <<~\parsel{Penssess-tu que la réponsse est non~?}~>>

Harry ignorait comment répondre, mais il était presque certain que sa réponse n'aurait pas d'importance.

<<~\parsel{Tu as raison, petit. Détruire ces cinq-là ne me rendrait pas mortel.}~>>
...
--- \parsel{Oui. Je reviendrais vite, si ce corps est détruit. Je serais très énervé et je me vengerai}. Je te dis cela, petit, pour que tu ne tentes rien de stupide.
...
--- \parsel{J'y crois}, dit le professeur Quirrell. On comble certaines zones d'ombre quand on raconte une histoire~; je n'étais pas présent quand Perenelle a séduit Baba Yaga. \parsel{Cela devrait être en grande partie correct}.~>>
...
<<~\parsel{Avez-vous modifié cette carte pour obtenir ce résultat ou avez-vous été ssurpris en le découvrant~?}
...
--- Fascinant, dit le professeur Quirrell. Ceci pourrait t'intéresser, alors~: \parsel{Le faiseur de potions devait œuvrer en ssecret parce que sson plan ss'opposait au plan du maître de l'école.}~>>
...
<<~\parsel{Il y avait un moyen de le tester sans mourir.} L'idée au sens plus général est importante. Est-ce que vous comprenez, maintenant~?
