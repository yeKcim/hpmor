...
% Letters
\newcommand{\letterAddress}[1]{\pagebreak[1]\noindent{}\fontspec[ExternalLocation]{ArchitectsDaughter.ttf}\scriptsize#1\nopagebreak[4]\par}
\newcommand{\letterClosing}[2][\vskip 1\baselineskip]{\nopagebreak[4]\fontspec[ExternalLocation]{ArchitectsDaughter.ttf}\scriptsize#1\par\nopagebreak[5]\noindent#2}

\newenvironment{writtenNote}{\fontspec[ExternalLocation]{ArchitectsDaughter.ttf}\scriptsize%
