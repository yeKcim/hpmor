...
\newcommand\McGonagallWhiteBoard[1]{
	\begin{center}
		\fontspec[ExternalLocation,Color=AA0000]{Halogen.ttf}
		\textcolor{blue}{\underline{\textcolor{red}{\MakeUppercase{#1}}}}
	\end{center}
}
...
\newcommand{\headline}[1]{\begin{center}\textsc{\fontspec[ExternalLocation]{FreeMonoBold.ttf}#1}\end{center}}
...
% Newspaper headlines
\newcommand{\inlineheadline}[1]{\textsc{\fontspec[ExternalLocation]{FreeMonoBold.ttf}#1}}
