...
ebook-convert output/hpmor.html output/hpmor.epub --no-default-epub-cover --cover tmp/title-en.jpg --authors "Eliezer Yudkowsky" --title "Harry Potter et les Méthodes de la Rationalité" --book-producer "Torben Menke" --pubdate 2015-03-14 --language fr-FR
